...
plt.title('Lasso: MSE and R2 Scores as Functions of Lambda (Degree = 5)')
...
for lambda_val in lambda_values:
    ...
    # Add a title and show the plot
    plt.title(f'Lasso: MSE and R2 Scores as Functions of Polynomial Degree (Lambda = {lambda_val})')
    ax1.legend(loc="upper left")
    ax2.legend(loc="upper right")
    plt.show()
