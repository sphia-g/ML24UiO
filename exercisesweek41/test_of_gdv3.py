...
beta_adam = stochastic_gradient_descent(X, y, initial_beta, learning_rate, n_iterations, gamma, momentum_gamma=0.999, approx=adam)
## beta1=0.9, beta2=0.999
beta_adagrad_momentum = stochastic_gradient_descent(X, y, initial_beta, learning_rate, n_iterations, momentum=True,approx=adagrad)
beta_rmsprop_momentum = stochastic_gradient_descent(X, y, initial_beta, learning_rate, n_iterations, momentum=True, approx=rmsprop)
beta_pg_S = sgd(X, y, initial_beta, learning_rate, n_iterations)
beta_adagrad_S = stochastic_gradient_descent_adagrad(X,y,initial_beta, learning_rate, n_iterations, adagrad=True)
beta_adagrad_momentum_S = stochastic_gradient_descent_momentum_adagrad(X, y, initial_beta, learning_rate, n_iterations, gamma, adagrad=True)
beta_adam_S = adam_stochastic_gradient_descent(X, y, initial_beta, learning_rate, n_iterations)
